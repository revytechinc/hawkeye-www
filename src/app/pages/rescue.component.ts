...
@Component({
  ...
  template: `
    <article class="min-w-0 max-w-3xl">
      ...
      <p class="mt-4 text-base sm:text-lg">Hawkeye is trench-warfare medicine, not a hospital. The host is a casualty: root may be read-only, /usr may be gone, the NIC may be dead. These tiers are the aid station, in plain language.</p>
